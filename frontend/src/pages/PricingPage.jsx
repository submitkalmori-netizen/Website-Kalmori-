...
const plans = [
  {
    ...
    tagline: 'Start distributing — no upfront cost',
    badge: 'FREE FOREVER', badgeStyle: 'bg-[#333] text-white', highlight: false,
    icon: <Lightning className="w-7 h-7" weight="fill" />,
    revenueShare: '20%',
    revenueNote: 'Kalmori keeps 20% of your royalties',
    color: '#888',
    features: [
      { text: 'Unlimited releases (Singles, EPs, Albums)', included: true },
      ...
      { text: 'Pay per release', included: false },
  ...
  {
    id: 'rise', name: 'Rise', price: 24.99, period: '/release',
    tagline: 'Pay per release. Keep more royalties.',
    ...
    revenueShare: '5%',
    revenueNote: 'Kalmori keeps only 5% of your royalties',
    color: '#7C4DFF',
    features: [
      { text: 'Single releases (pay per release)', included: true },
      { text: '150+ streaming platforms', included: true },
      { text: 'Free ISRC & UPC codes', included: true },
      { text: 'Advanced analytics & revenue dashboard', included: true },
      { text: 'Fan Analytics', included: true },
      { text: 'Beat Marketplace access', included: true },
      { text: 'In-App Messaging', included: true },
      { text: 'Goal Tracking', included: true },
      { text: 'Priority support', included: true },
      { text: 'AI Release Strategy', included: false },
      { text: 'YouTube Content ID', included: false },
      { text: 'Album releases', included: false },
    ],
  },
  {
    id: 'pro', name: 'Pro', price: 49.99, period: '/mo',
    tagline: 'Maximum power. Keep 100% of royalties.',
    ...
    color: '#FFD700',
    features: [
      { text: 'Album + Single releases (unlimited)', included: true },
      { text: '150+ streaming platforms', included: true },
      { text: 'Free ISRC & UPC codes', included: true },
      { text: 'Keep 100% of royalties', included: true, highlight: true },
      ...
      { text: 'Collaborations & Royalty Splits', included: true },
